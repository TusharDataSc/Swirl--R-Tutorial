...
t1 <- Sys.time()
#
# view the content of t1
t1
## [1] "2018-01-15 12:25:50 CST"
#
# check the class() of t1
class(t1)
## [1] "POSIXct" "POSIXt" 
#
...
# | Assign the result to a new variable called t4. 
...
Sys.time() - t1
## Time difference of 22.36689 hours
...
## Time difference of 0.9335172 days
